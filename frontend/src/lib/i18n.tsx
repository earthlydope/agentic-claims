...
const DICT: Record<string, [string, string]> = {
  ...
  'wq.approve': ['Approve',
   'Genehmigen'],
  'wq.instead': ['instead', 'stattdessen'],
  'wq.verb.request_more': ['Ask for more', 'Nachfordern'],
  'wq.verb.reject': ['Reject', 'Ablehnen'],
  'wq.verb.confirm': ['Confirm the technical position', 'Technische Beurteilung bestätigen'],
  'wq.verb.release': ['Release — nothing established', 'Freigeben — nichts festgestellt'],
  'wq.verb.refer': ['Refer for investigation', 'Zur Prüfung vorlegen'],
  'wq.verb.recovered': ['Recovery being pursued', 'Regress wird verfolgt'],
  'wq.verb.no_recovery': ['Not worth pursuing', 'Nicht verfolgenswert'],
  'wq.reject': ['Reject',
   'Ablehnen'],
